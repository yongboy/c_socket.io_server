/**
**  gcc test_ws.c ../c-websocket/*.c -o test_ws ../include/libev.a ../http-parser/http_parser.o -lm
*/
#include <sys/types.h>
    ...
    // if (client->parser.upgrade) {
        ...
        if (client->head_done == 0) {
            ...
            if (result == -2) {
                ...
                printf("write back message is %s\n", dst);
