/**
**  gcc test_websocket.c ../c-websocket/*.c -o test_websocket ../include/libev.a ../http-parser/http_parser.o -lm
*/
#include <sys/types.h>
...
void write_ws_msg(client_t *cli, char *msg) {
    ...
    if(len > 80 && len < 200){
        ...
        target_msg = tt;
         // WEBSOCKET_set_content(tt, strlen(tt), dst, 10240);
        // write_msg(cli, dst);
        // return;
    }else{
        target_msg = msg;
    ...
    printf("target_msg is %s||\n", target_msg);
    WEBSOCKET_set_content(target_msg, strlen(target_msg), dst, 10240);
    write_msg(cli, dst);
}
    ...
    // if (client->parser.upgrade) {
        ...
        if (client->head_done == 0) {
            ...
            if (result == -2) {
                ...
                // write_msg(client, rbuff);
                 // write_ws_msg(client, "5::/chat:{\"name\":\"user message\",\"args\":[\"firefox\",\"顶顶顶顶的顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶\"]}");
                // write_ws_msg(client, "顶顶顶顶的顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶的顶顶顶顶顶顶顶顶顶顶的顶顶");//152
